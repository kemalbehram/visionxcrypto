...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 28, 2020 at 12:16 PM
...
CREATE TABLE IF NOT EXISTS `banks` (
  ...
  `accname` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE IF NOT EXISTS `basic_settings` (
  ...
  `baseurl` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phone` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `email` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `address` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `currency` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `currency_sym` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `registration` tinyint(1) NOT NULL DEFAULT '0',
  `login` int(55) NOT NULL,
  `maintain` int(55) DEFAULT NULL,
  `rubies_secretkey` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `rubies_publickey` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `clubkonnect_key` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `clubkonnect_id` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `sms_token` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `husmotoken` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `decoderfee` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `electricityfee` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `smscharge` varchar(77) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_verification` tinyint(1) NOT NULL DEFAULT '0',
  `sms_verification` tinyint(1) NOT NULL DEFAULT '0',
  `email_notification` tinyint(1) NOT NULL DEFAULT '0',
  `sms_notification` tinyint(4) NOT NULL DEFAULT '0',
  `level_one` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `level_two` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `level_three` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sending_charge` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `transcharge` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `depocharge` varchar(77) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `decimal` int(2) NOT NULL,
  `cron` tinyint(4) NOT NULL DEFAULT '0',
  `map_api` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `trxcancel` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `bonus` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `minbonus` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ref` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kyc` varchar(44) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `bvn` varchar(77) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `step4` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `step5` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `htitle` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `hstitle` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `theme` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `timezone` varchar(99) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `claims` (
  ...
  `wallet_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `cryptowallets` (
  ...
  `user_id` int(11) NOT NULL,
  `balance` varchar(17) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `currencies` (
  ...
  `icon` varchar(22) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `api_id` int(55) DEFAULT NULL,
  `price` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `exchange` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `sell` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `buy` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `deposits` (
  ...
  `usd` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `gateways` (
  ...
  `val1` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE IF NOT EXISTS `internets` (
  ...
  `amount` varchar(99) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `price` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `network` varchar(77) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` tinyint(4) NOT NULL DEFAULT '0',
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `invests` (
  ...
  `trx` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tnum` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `btcwallet` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `btcvalue` varchar(77) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
...
INSERT INTO `invests` (`id`, `user_id`, `plan_id`, `amount`, `interest`, `period`, `hours`, `time_name`, `return_rec_time`, `last_time`, `status`, `capital_status`, `trx`, `tnum`, `btcwallet`, `btcvalue`, `image`, `created_at`, `updated_at`) VALUES
(1, 10, 1, '500.00', '50.00', 5, '1', 'Hourly', 4, '2020-10-06 21:56:39', 1, 1, 'FCTRB48WKZZ9', NULL, NULL, '', NULL, '2020-10-02 03:57:28', '2020-10-06 21:56:39'),
(2, 10, 1, '500.00', '50.00', 5, '1', 'Hourly', 4, '2020-10-06 21:56:39', 1, 1, '189256271037', NULL, NULL, '', NULL, '2020-10-02 12:27:16', '2020-10-06 21:56:40'),
(3, 10, 2, '1000.00', '200.00', 10, '168', 'Weekly', 0, NULL, 1, 1, '536781120045', NULL, NULL, '', NULL, '2020-10-02 12:27:51', '2020-10-02 12:27:51'),
(4, 19, 2, '1234.00', '246.80', 10, '168', 'Weekly', 0, NULL, 1, 1, '48949140554', NULL, NULL, '', NULL, '2020-10-02 13:46:36', '2020-10-02 13:46:36'),
(5, 10, 1, '12.00', '1.20', 5, '1', 'Hourly', 4, '2020-10-06 21:56:39', 1, 1, '786364777027', NULL, NULL, '', NULL, '2020-10-02 13:48:58', '2020-10-06 21:56:40'),
(6, 10, 1, '12.00', '1.20', 5, '1', 'Hourly', 4, '2020-10-06 21:56:39', 1, 1, '68749845214', NULL, NULL, '', NULL, '2020-10-02 13:51:38', '2020-10-06 21:56:40'),
(7, 10, 1, '500.00', '50.00', 5, '1', 'Hourly', 3, '2020-10-06 21:56:39', 1, 1, '314035193384', NULL, NULL, '', NULL, '2020-10-03 05:31:19', '2020-10-06 21:56:40'),
(8, 10, 2, '12.00', '24.00', 2, '168', 'Weekly', 0, NULL, 0, 0, '73333632878', NULL, NULL, '', NULL, '2020-10-06 19:52:12', '2020-10-06 19:52:12'),
(9, 10, 2, '12.00', '24.00', 2, '168', 'Weekly', 0, NULL, 17, 0, '408109182923', 'xdgssgsdgsd436626236tadasasasg', NULL, '', '5f7ce101f4036.jpg', '2020-10-06 19:53:02', '2020-10-06 20:49:25'),
(10, 10, 2, '12.00', '24.00', 2, '168', 'Weekly', 0, NULL, 17, 0, '324830923776', 'dsfsdg235236236236', NULL, '', '5f7d0118f07f3.jpg', '2020-10-06 22:42:59', '2020-10-07 12:20:25'),
(11, 10, 1, '12.00', '1.20', 5, '1', 'Hourly', 0, NULL, 2, 1, '772929328277', '3252352352326', NULL, '', '5f7ec832cd731.jpg', '2020-10-08 07:02:54', '2020-10-08 07:05:06'),
(12, 10, 2, '12.00', '24.00', 2, '168', 'Weekly', 0, NULL, 2, 0, '153853406451', '25235235', 'dsfsfdffasfasasgasgs', '', '5f7edada85b7e.jpg', '2020-10-08 07:30:12', '2020-10-08 08:24:42'),
(13, 10, 2, '12.00', '24.00', 2, '168', 'Weekly', 0, NULL, 101, 0, '404450614764', NULL, NULL, '', NULL, '2020-10-08 08:28:59', '2020-10-08 08:28:59'),
(14, 10, 1, '500.00', '50.00', 5, '1', 'Hourly', 0, NULL, 1, 1, '383628817231', NULL, NULL, '', NULL, '2020-10-08 08:30:56', '2020-10-08 08:30:56'),
(15, 10, 1, '500.00', '50.00', 5, '1', 'Hourly', 0, NULL, 101, 1, '29038942016', NULL, NULL, '', NULL, '2020-10-08 08:32:47', '2020-10-08 08:32:47'),
(16, 10, 1, '100.00', '10.00', 5, '1', 'Hourly', 0, NULL, 101, 1, '23505438902', NULL, NULL, '0.009173', NULL, '2020-10-08 14:22:07', '2020-10-08 14:22:07'),
(17, 10, 1, '500.00', '50.00', 5, '1', 'Hourly', 0, NULL, 2, 1, '43180120207', '4564', '54745636356', '0.045235000000000004', '5f80b90baa3d6.jpg', '2020-10-09 18:23:22', '2020-10-09 18:24:59'),
(18, 10, 3, '41.00', '87.33', -1, '168', 'Weekly', 0, NULL, 1, 0, '35621028946', NULL, NULL, '0', NULL, '2020-10-27 13:13:59', '2020-10-27 13:13:59');
...
DROP TABLE IF EXISTS `investyields`;
CREATE TABLE IF NOT EXISTS `investyields` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `invest_id` varchar(77) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
  `amount` decimal(11,2) DEFAULT '0.00',
  `main_amo` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
DROP TABLE IF EXISTS `localbanks`;
...
CREATE TABLE IF NOT EXISTS `networks` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `code` varchar(77) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `symbol` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `image` varchar(99) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `min` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `max` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `payment_methods` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `withdraw_min` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '1',
  `withdraw_max` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '10',
  `fix` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `percent` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `powers` (
  ...
  `image` varchar(99) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `code` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `billercode` varchar(99) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type` varchar(77) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` tinyint(4) NOT NULL DEFAULT '0',
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `smss` (
  ...
  `phone` varchar(22) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `amount` varchar(77) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `testimonials` (
  ...
  `code` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `time_settings` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `slug` varchar(77) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `transactions` (
  ...
  `account_number` varchar(77) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pin` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `serial` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `unit` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ref` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `gateway` varchar(77) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `trxes` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL DEFAULT '0',
  `amount` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `main_amo` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `amountpaid` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `depositor` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `action` varchar(77) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `title` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `tnum` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `image` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `charge` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `type` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '+',
  `wallet` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `currency_id` int(11) DEFAULT NULL,
  `rate` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `price` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `getamo` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `method` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bank` varchar(77) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `trx` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bankname` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `timeout` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `bvn_time` varchar(66) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `bonus` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0.00',
  `bank` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Not Set',
  `bankcode` varchar(77) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `accountno` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `accountname` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `bankyes` int(1) NOT NULL DEFAULT '0',
  `paypal` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Not Set',
  `btcaddress` varchar(77) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Not Set',
  `ethaddress` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `ltcaddress` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `status` tinyint(4) NOT NULL DEFAULT '1',
  `verified` int(22) DEFAULT NULL,
  `dob` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gender` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `login_time` datetime DEFAULT NULL,
  ...
  `timezone` varchar(77) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `withdrawpass` varchar(77) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '1234',
...
(10, 'Adekunle', 'Gold', 'test1234', 'test@test.com', '+23480319753979', '4460008942', 'assets/images/user/1601558082_.jpg', '$2y$10$6mWJLg2o4h2KoRncGfaS4urjj8H3XxrpD3xta4uoeIWoNDWrwkTkS', 'PYS4M1', 'ARCQOH', 1, 1, 1, '2020-10-17 21:50:42', '2020-04-06 22:53:38', '2020-10-28 11:03:08', 0, 1, NULL, '2930', '109', 'ACCESS BANK PLC', '000014', '0033349394', 'ADETUNJI AYORINDE OL', 1, 'user@paypal.com', 'btcwallet', 'Ethwallet', 'Ltcwallet', 1, 0, '02/06/2020', NULL, '2020-12-05 00:35:56', 'My Address Is Real, Adekola', 'Ikeja', NULL, '234', 'Nauru', NULL, NULL, 'fiI82OQ822lpmcT8njzwK9NY25JR9QRidTnH8VkEwJYQ8T4AjFRSqgrpgI5M', NULL, '2020-04-06 21:48:38', '2020-12-04 23:35:56', '2020-05-17 08:25:00', 'Africa/Lagos', '1234', 0, 0, NULL),
...
(25, 'joseph', 'joseph', 'joseph1995', 'joezy1995@gmail.com', '08156995030', '4460391822', 'assets/images/user/1604685175_.jpg', '$2y$10$o0tZBQtuoheO8Nfn7izXTeaFsjR1mPlqHQVk/QA5z0Pak4WUZ04Fq', 'ASBXDW', '0NP3QG', 1, 1, 0, NULL, '2020-10-27 23:29:12', '2020-10-27 23:34:37', 0, 0, NULL, '0', '0.00', 'Access Bank', NULL, '0811911645', 'AFESHIMIME  AKANJI', 0, 'Not Set', 'Not Set', '0', '0', 1, 0, 'February', NULL, '2020-12-04 14:07:56', 'Lagos', 'Lagos', NULL, '100261', NULL, NULL, NULL, 'TZfRgZQYZhqVHjKrUo9qmoK1OCsY51R21a8caJuiWXjguP8hHzJCeqZSgsGj', NULL, '2020-10-28 03:24:12', '2020-12-04 13:07:56', NULL, 'Africa/Lagos', '1995', 0, 0, NULL),
...
(36, 'Samji', 'Baba', 'sammy', 'samji@visionx.com', '08166939206', NULL, NULL, '$2y$10$PBOFnnr9IO1GZeJsuGIQ3.6SfelISF/bDeXWhEo35j.lI5mVKM2va', 'Z7QWAP', 'PUDYQM', 0, 1, 0, NULL, '2020-12-09 19:47:56', '2020-12-09 19:43:56', 0, 0, NULL, '0', '0.00', 'Not Set', NULL, NULL, NULL, 0, 'Not Set', 'Not Set', '0', '0', 1, NULL, NULL, NULL, '2020-12-09 19:43:02', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2020-12-09 18:42:56', '2020-12-09 18:43:02', NULL, 'Africa/Lagos', '1234', 0, 0, 'Xd7BsmnHZN9vZBC954olMpZhN2qVSZY37dJ4nSAUB0bozYw90vhj8AT52XVJ');
...
(349, 10, '::1', 'Unknown', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.193 Safari/537.36', '2020-11-17 10:07:54', '2020-11-17 10:07:54'),
(350, 10, '::1', 'Unknown', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.193 Safari/537.36', '2020-11-17 10:15:06', '2020-11-17 10:15:06'),
(351, 10, '::1', 'Unknown', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.193 Safari/537.36', '2020-11-17 10:16:02', '2020-11-17 10:16:02'),
(352, 10, '::1', 'Unknown', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.193 Safari/537.36', '2020-11-17 20:19:01', '2020-11-17 20:19:01'),
(353, 10, '::1', 'Unknown', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36', '2020-11-18 11:26:02', '2020-11-18 11:26:02'),
(354, 31, '::1', 'Unknown', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36', '2020-11-18 15:12:06', '2020-11-18 15:12:06'),
(355, 10, '::1', 'Unknown', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:83.0) Gecko/20100101 Firefox/83.0', '2020-12-03 00:33:16', '2020-12-03 00:33:16'),
(356, 10, '::1', 'Unknown', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36', '2020-12-03 01:25:40', '2020-12-03 01:25:40'),
(357, 10, '::1', 'Unknown', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36', '2020-12-03 10:15:44', '2020-12-03 10:15:44'),
(358, 25, '::1', 'Unknown', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36', '2020-12-03 10:35:25', '2020-12-03 10:35:25'),
(359, 10, '::1', 'Unknown', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36', '2020-12-03 12:10:12', '2020-12-03 12:10:12'),
(360, 25, '::1', 'Unknown', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36', '2020-12-03 12:10:32', '2020-12-03 12:10:32'),
(361, 10, '::1', 'Unknown', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36', '2020-12-03 20:42:41', '2020-12-03 20:42:41'),
(362, 25, '::1', 'Unknown', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36', '2020-12-04 06:36:37', '2020-12-04 06:36:37'),
(363, 10, '::1', 'Unknown', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36', '2020-12-04 12:08:03', '2020-12-04 12:08:03'),
(364, 25, '::1', 'Unknown', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36', '2020-12-04 13:07:58', '2020-12-04 13:07:58'),
(365, 10, '::1', 'Unknown', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36', '2020-12-04 18:03:45', '2020-12-04 18:03:45'),
(366, 10, '::1', 'Unknown', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36', '2020-12-04 21:22:33', '2020-12-04 21:22:33'),
(367, 10, '::1', 'Unknown', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:83.0) Gecko/20100101 Firefox/83.0', '2020-12-04 23:35:56', '2020-12-04 23:35:56'),
(368, 35, '::1', 'Unknown', 'PostmanRuntime/7.26.8', '2020-12-05 12:41:19', '2020-12-05 12:41:19'),
(369, 35, '::1', 'Unknown', 'PostmanRuntime/7.26.8', '2020-12-05 12:42:49', '2020-12-05 12:42:49'),
(370, 35, '::1', 'Unknown', 'PostmanRuntime/7.26.8', '2020-12-05 13:27:30', '2020-12-05 13:27:30'),
(371, 35, '::1', 'Unknown', 'PostmanRuntime/7.26.8', '2020-12-05 13:29:54', '2020-12-05 13:29:54'),
(372, 35, '::1', 'Unknown', 'PostmanRuntime/7.26.8', '2020-12-05 13:31:24', '2020-12-05 13:31:24'),
(373, 36, '::1', 'Unknown', 'PostmanRuntime/7.26.8', '2020-12-09 18:43:02', '2020-12-09 18:43:02');
...
CREATE TABLE IF NOT EXISTS `user_wallets` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT NULL,
  `balance` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0.00000000',
...
(16, 33, '0', 'interest_wallet', 1, '2020-12-05 12:20:31', '2020-12-05 12:20:31'),
(17, 34, '0', 'interest_wallet', 1, '2020-12-05 12:21:42', '2020-12-05 12:21:42'),
(18, 35, '0', 'interest_wallet', 1, '2020-12-05 12:41:00', '2020-12-05 12:41:00'),
(19, 36, '0', 'interest_wallet', 1, '2020-12-09 18:42:56', '2020-12-09 18:42:56');
...
CREATE TABLE IF NOT EXISTS `verifieds` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` int(55) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `virtual_cards` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='This table holds virtual cards created';

--
-- Dumping data for table `virtual_cards`
--

INSERT INTO `virtual_cards` (`id`, `user_id`, `name`, `pan`, `masked_pan`, `city`, `state`, `address`, `postal_code`, `cvv`, `expiration`, `type`, `country`, `currency`, `amount`, `status`, `card_id`, `created_at`) VALUES
(1, 10, 'Samji Diamond', '5366130699778900', '536613*******8900', 'San Francisco', 'CA', '333 fremont road', NULL, 134, '2023-01', 'mastercard', 'NG', 'NGN', 2120, 'active', '43ec6e92-9eb7-48ad-91c8-7bee425a33cf', '2020-11-15 21:36:54'),
(2, 10, 'Baddest Nigga', '5366130699778900', '536613*******8900', 'San Francisco', 'CA', '333 fremont road', NULL, 134, '2023-01', 'mastercard', 'US', 'USD', 3, 'active', '43ec6e92-9eb7-48ad-91c8-7bee425a33cf', '2020-11-15 21:37:18');
