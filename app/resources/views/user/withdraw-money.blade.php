...
<div class="page-content"><div class="container"><div class="content-area card"><div class="card-innr"><div class="card-head"><div class="step-number">01</div><div class="step-head-text"><h4>Payment Wallet</h4><p>Please fill the form below to process your withdrawal</p></div><div class="gaps-1x"></div><ul class="nav nav-tabs nav-tabs-line"  role="tablist"><li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#tab-item-5">Deposit Wallet</a></li><li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab-item-4">Crypto Wallet</a></li></ul><div class="tab-content"><div class="tab-pane fade " id="tab-item-4"><h4>Please fill the form below to withdraw from your cryptocurrency wallets</h4><p>

<div class="input-item input-with-label"><label for="swalllet" class="input-item-label text-exlight">Select Withdrawal Wallet </label>
...
<a href="#" class="btn btn-primary  disabled " data-toggle="modal"data-target="#crypto" ><li class="fa fa spinner spin"></li>Coming Soon</a>

</p></div>

<div class="tab-pane fade active show" id="tab-item-5"><h4>Please fill the form below to withdrawal from your deposit wallet</h4><p>
...
<div class="input-item input-with-label"><label for="token-address" class="input-item-label text-exlight">Select Withdrawal Method:</label>
...
<div class="gaps-1x"></div>
<h6 class="input-item-label text-exlight">Enter amount to withdraw</h6><div class="copy-wrap mgb-0-5x"><span class="copy-feedback"></span><input  required  type="number" name="amount" placeholder="{{$basic->currency_sym}} 0.00" class="copy-address" ><badge class="copy-trigger copy-clipbhoard">{{$basic->currency}}</badge></div>
