											...
											<div class="row">
												<div class="col-xl-12 col-lg-12 col-md-12 d-block mx-auto">
														...
														<div class="buy-sell">
															<div class="form row mx-auto justify-content-center d-flex p-4">
																<div class="form-group col-xl-6 col-lg-6 col-md-12 mb-0">
																	<input type="text" class="form-control mb-4 mb-lg-0" i disabled="" value="{{$bank}}">
																</div>
																<div class="form-group col-xl-6 col-lg-6 col-md-12 mb-0">
																	<input type="text" class="form-control mb-4 mb-lg-0" i disabled="" value="{{$number}}">
																</div>
																<div class="col-xl-12 col-lg-12 col-md-12 my-3 text-left">
																	<i class=" fa fa-bank exchange-icon tx-30 text-white inline-block"></i>
																</div>
																<div class="form-group  col-xl-6 col-lg-6 col-md-12 mb-0">
																	<input type="text" class="form-control mb-4 mb-lg-0" i disabled="" value="{{$name}}">
																</div>
																<div class="form-group col-xl-6 col-lg-6 col-md-12 mb-0">
													...
													<div class="text-center background-text">
														<button href="#" data-toggle="modal" data-target="#myModal" class="btn btn-warning pl-6 pr-6 pt-2 pb-2 mx-auto float-left mt-5">TRANSFER NOW</button>
													</div>
												</div>
											</div>
										</div>
