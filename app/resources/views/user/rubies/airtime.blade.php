				...
				<div class="container-fluid">
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Airtime Recharge History</h2>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#">Dashboard</a></li>
									<li class="breadcrumb-item active" aria-current="page">Airtime History</li>
								</ol>
							</div>
								...
								<div class="card custom-card">
									<div class="card-body">
										<div class="card-order ">
											...
											<img width="40"  class=" icon-size float-left text-primary" src="{{url('assets/images')}}/{{$data->image}}" alt=""><span class="font-weight-bold">{{$basic->currency_sym}}{{number_format(App\Transaction::whereUser_id(Auth::user()->id)->whereType(1)->whereStatus(1)->whereGateway($data->symbol)->sum('amount'),2)}}</span></h2>
							...
							<div class="col-md-12 col-lg-12 col-xl-12">
								<div class="card custom-card transcation-crypto">
									<div class="card-header border-bottom-0">
										<div class="main-content-label">Airtime Recharge Log</div> 
									</div>
									<div class="card-body">
