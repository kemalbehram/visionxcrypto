...
@section('content')
 ...
 <option value="Voters' Card">Voters' Card</option>
									...
									<div class="tab-pane fade show active" id="edit-profile2" role="tabpanel">
										...
										@if(Auth::user()->phone_verify != 1)
											<form action="#" class="left-space-fix bottom-border-style">
											<div class="block-title font-fix">Phone Verification <span class="status-alert disabled">Unverified</span></div>
											<div class="sub-text">Proceeding with this means we'll send you a security code to verify your phone number with us.</div>
										...
										<form action="#" class="left-space-fix bottom-border-style">
											...
											<button type="button" class="theme-button authenticator-enable-button" data-toggle="modal" data-target="#email-verification"><span></span>Verify BVN</button>
										</form>
									    @endif
									</div> <!-- /.tab-pane -->
			    	...
			    	<div class="modal-content">
				    	<div class="tabs-wrap">
							<ul class="nav nav-tabs modal-navs" id="myTab" role="tablist">
								<li class="nav-item">
								  <a class="nav-link active" id="add-number-tab" data-toggle="tab" href="#add-number" role="tab" aria-controls="add-number" aria-selected="true"></a>
								</li>
								<li class="nav-item">
								  <a class="nav-link" id="verification-code-tab" data-toggle="tab" href="#verification-code" role="tab" aria-controls="verification-code" aria-selected="false"></a>
								</li>
							</ul>
							<div class="tab-content" id="myTabContent">
								<div class="tab-pane fade show active" id="add-number" role="tabpanel" aria-labelledby="add-number-tab">
								    ...
								    <div class="modal-body">
				        				<form action="#">
				        					<input id="phone" readonly  value="{{Auth::user()->phone}}" type="tel" class="font-fix">
								...
								<div class="tab-pane fade" id="verification-code" role="tabpanel" aria-labelledby="verification-code-tab">
								  	<div class="theme-modal-header">
								      	<h3 class="title"><a class="back-button"><img src="images/left-arrow.png" alt=""></a> A verification code was <br> sent to your phone</h3>
										 ...
										 @csrf
										  <input type="hidden" name="id" value="{{Auth::user()->id}}">
				        					...
				        					<div class="button-group clearfix">
				        						<ul class="clearfix">
				        							<li><button type="submit" class="theme-button"><span></span>Verify</button></li>
										</form>
			...
			<div class="modal fade settings-page-modal" id="authenticator-modal" tabindex="-1" role="dialog" aria-hidden="true">
			  	<div class="modal-dialog" role="document">
			    	<div class="modal-content">
					    ...
					    <div class="modal-body verification-code-details">
				        	  <form class="code-verify" class="code-verify" action="{{ route('user.email-verify')}}" method="post">
							 @csrf
				        		<input type="text"  name="sms_code" placeholder="Enter your code"  class="font-fix">
				        		<div class="button-group clearfix">
				        			<ul class="clearfix">
