                            ...
                            <div class="tab-content">
                                ...
                                <div class="main-content-body tab-pane p-4 border-top-0 active" id="bvn">
                                    <div class="card-body border">
                                        ...
                                        @endif
                                        @if(Auth::user()->bvn_verify != 1)
                                            <p>We need your BVN to be able to process transactions and verify your
                                                identity.
                                                Dial *565*0# on your device to view your BVN</p>
                                            <form class="form-horizontal" action="{{ route('user.bvn-verify')}}"
                                                  method="post">
                                                @csrf
                                                <div class="form-group ">
                                                    <div class="row row-sm">
                                                        <div class="col-md-9">
                                                            <input class="form-control" name="bvn"
                                                                   placeholder="Enter your BVN" type="tel">
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card-body border">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table mb-0 border-top table-bordered text-nowrap">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @if(Auth::user()->bankyes == 1)
                                                                    <button class="btn btn-success btn-sm">Verified
                                                                    </button>
                                                                @elseif(Auth::user()->verified == 0)
                                                                    <button class="btn btn-warning btn-sm">Pending
                                                                    </button>
                                                                @elseif(Auth::user()->verified == 2)
                                                                    <button class="btn btn-danger btn-sm">Rejected
                                                                    </button>
                                                                @endif
                                                            </td>
                                                        </tr>
                                        ...
                                        @if(Auth::user()->bankyes != 1)
                                            <p>Please update your bank account details below. You will need this to
                                                facilitate your fund withdrawal from {{$basic->sitename}}</p>
                                            <form class="form-horizontal" action="{{route('post.banky') }}"
                                                  method="post">
                                                @csrf
                                                <div class="form-group ">
                                                    <div class="row row-sm">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row row-sm">
                                                        <div class="col-md-9">
                                                            <input class="form-control" name='actnumber'
                                            ...
                                            <div class="border p-4">
                                                <div class="main-content-body main-content-body-profile">
                                                    ...
                                                    <div class="main-content-body tab-pane p-4 border-top-0 active"
                                                        ...
                                                        <div class="card-body border">
                                                            <label for="cars">Choose your prefered verification
                                                                document:</label>
                                                        ...
                                                        <br><br>
                                                        <div class="mb-4 main-content-label">Expiry Date</div>

                                                        <div class="form-group ">
                                                            <div class="row row-sm">
                                                                <div class="col-md-9">
                                                                    <input type="date" class="form-control"
                                                                           placeholder="User Name" name="date">
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="row row-sm">
                                                                <div class="col-md-9">
                                                                    <div class="input-group file-browser">
                                                                        ...
                                                                        <label class="input-group-btn">
														<span class="btn btn-primary">
															Browse <input type="file" name="photo2"
                                                                          accept="image/png, image/jpeg"
                                                                          style="display: none;" multiple>
														</span>
                                                                        </label>
                                                            ...
                                                            <div class="row row-sm">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <div class="custom-controls-stacked">
                                                                        <br>
                                                                        <button type="submit"
                                                                                class="btn btn-primary ml-auto">Verify
                                                                            Now
                                                                        </button>
                                                                        <br><br>
                                                                    </div>
