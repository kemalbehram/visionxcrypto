                            ...
                            <div class="card-body">
                                <div class="panel profile-cover">
                                    <div class="profile-cover__img">
                                        <img src="{{url('assets/assets/img/media/uploadphoto.png')}}" alt="img" />
...
{{--                                        </button>--}}
                                ...
                                <div class="profile-tab tab-menu-heading">
                                    <nav class="nav main-nav-line p-3 tabs-menu profile-nav-line bg-gray-100">
                                        <a class="nav-link  active" data-toggle="tab" href="#about">Shop</a>
                                        <a class="nav-link" data-toggle="tab" href="#edit">Customers</a>
                                        <a class="nav-link" data-toggle="tab" href="#timeline">Verification</a>
                                        <a class="nav-link" data-toggle="tab" href="#gallery">Account</a>
                            ...
                            <div class="tab-content">
                                <div class="main-content-body tab-pane p-4 border-top-0 active" id="about">
                                    <div class="card-body p-0 border p-0 rounded-10">
                                        <div class="p-4">
                                            ...
                                            <p class="m-b-5" style="margin-bottom: 60px">Bella shoes and bags your number one body wears for both kids, and adult</p>
                                            <button type="button" class="btn ripple btn-dark btn-lg btn-block btn-rounded mt-lg-5">Create Paylink</button>
                                ...
                                <div class="main-content-body tab-pane p-4 border-top-0" id="edit">
                                    <div class="card-body border">
                                        <div class="mb-4 main-content-label">Customers</div>
                                ...
                                <div class="main-content-body tab-pane p-4 border-top-0" id="timeline">
                                    <div class="card-body border">
                                        ...
                                        <form class="form-horizontal">
                                            <div class="mb-4 main-content-label">Business Information</div>
                                            <div class="form-group ">
                                                <div class="row row-sm">
                                                    ...
                                                    <div class="col-md-1">
                                                        <span class="badge badge-pill badge-warning pd-x-10"><span class="pd-t-5 pd-b-5" style="color: white">Pending</span></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row row-sm">
                                                    ...
                                                    <div class="col-md-8">
                                                        <textarea class="form-control" name="example-textarea-input" rows="5" placeholder="Address"></textarea>
                                                    </div>
                                            ...
                                            <div class="mb-4 main-content-label">Document</div>
                                            <div class="form-group ">
                                                <div class="row row-sm">
                                                    <div class="col-md-3">
                                                        <label class="form-label">Business certificate (Optional)</label>
                                                    </div>
                                                    <div class="col-md-8">
                                                        <input type="file" >
                                ...
                                <div class="main-content-body  tab-pane border-top-0" id="timeline2">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="card mg-b-20 border">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="row row-sm">
                                                                    <div class="col"> <img alt="img" class="wd-200 mr-4" src="../../assets/img/media/1.jpg"> <img alt="img" class="wd-200" src="../../assets/img/media/2.jpg"> </div>
                                                                </div>
                                                        ...
                                                        <div class="card mg-b-20 border">
                                                            ...
                                                            <div class="card-body h-100">
                                                                <p class="mg-t-0">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
                                                                <div class="row row-sm">
                                                                    <div class="col"> <img alt="img" class="wd-200 mr-4" src="../../assets/img/media/4.jpg"> <img alt="img" class="wd-200" src="../../assets/img/media/5.jpg"> </div>
                                                                </div>
                                                                <div class="media mg-t-15 profile-footer">
                                                                    <div class="media-user mr-2">
                                                                        <div class="demo-avatar-group">
                                                        ...
                                                        <div class="card border">
                                                            ...
                                                            <div class="card-body h-100">
                                                                <p class="mg-t-0">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
                                                                <div class="row row-sm">
                                                                    <div class="col"> <img alt="img" class="wd-200 mr-3" src="../../assets/img/media/4.jpg"> <img alt="img" class="wd-200" src="../../assets/img/media/7.jpg"> </div>
                                                                </div>
                                                                <div class="media mg-t-15 profile-footer">
                                                                    <div class="media-user mr-2">
                                                                        <div class="demo-avatar-group">
                                    ...
                                    <div class="card-body border">
                                        <div class="demo-gallery">
                                            <ul id="lightgallery" class="list-unstyled row row-sm">
                                                <li class="col-sm-6 col-lg-4" data-responsive="../../assets/img/media/1.jpg" data-src="../../assets/img/media/1.jpg" data-sub-html="<h4>Gallery Image 1</h4>">
                                                    <a href="" class="wd-100p"><img class="img-responsive mb-4 wd-100p" src="../../assets/img/media/1.jpg" alt="Thumb-1"> </a>
                                                </li>
                                                <li class="col-sm-6 col-lg-4" data-responsive="../../assets/img/media/2.jpg" data-src="../../assets/img/media/2.jpg" data-sub-html="<h4>Gallery Image 2</h4>">
                                                    <a href="" class="wd-100p"><img class="img-responsive mb-4" src="../../assets/img/media/2.jpg" alt="Thumb-1"> </a>
                                                </li>
                                                <li class="col-sm-6 col-lg-4" data-responsive="../../assets/img/media/3.jpg" data-src="../../assets/img/media/3.jpg" data-sub-html="<h4>Gallery Image 3</h4>">
                                                    <a href="" class="wd-100p"><img class="img-responsive mb-4" src="../../assets/img/media/3.jpg" alt="Thumb-1"> </a>
                                                </li>
                                                <li class="col-sm-6 col-lg-4" data-responsive="../../assets/img/media/4.jpg" data-src="../../assets/img/media/4.jpg" data-sub-html="<h4>Gallery Image 4</h4>">
                                                    <a href="" class="wd-100p"><img class="img-responsive mb-4" src="../../assets/img/media/4.jpg" alt="Thumb-1"> </a>
                                                </li>
                                                <li class="col-sm-6 col-lg-4" data-responsive="../../assets/img/media/5.jpg" data-src="../../assets/img/media/5.jpg" data-sub-html="<h4>Gallery Image 5</h4>">
                                                    <a href="" class="wd-100p"><img class="img-responsive mb-4" src="../../assets/img/media/5.jpg" alt="Thumb-1"> </a>
                                                </li>
                                                <li class="col-sm-6 col-lg-4" data-responsive="../../assets/img/media/6.jpg" data-src="../../assets/img/media/6.jpg" data-sub-html="<h4>Gallery Image 6</h4>">
                                                    <a href="" class="wd-100p"><img class="img-responsive mb-4" src="../../assets/img/media/6.jpg" alt="Thumb-1"> </a>
                                                </li>
                                                <li class="col-sm-6 col-lg-4" data-responsive="../../assets/img/media/7.jpg" data-src="../../assets/img/media/7.jpg" data-sub-html="<h4>Gallery Image 7</h4>">
                                                    <a href="" class="wd-100p"><img class="img-responsive mb-4 mb-lg-0" src="../../assets/img/media/7.jpg" alt="Thumb-1"> </a>
                                                </li>
                                                <li class="col-sm-6 col-lg-4" data-responsive="../../assets/img/media/8.jpg" data-src="../../assets/img/media/8.jpg" data-sub-html="<h4>Gallery Image 8</h4>">
                                                    <a href="" class="wd-100p"><img class="img-responsive mb-4 mb-lg-0" src="../../assets/img/media/8.jpg" alt="Thumb-1"> </a>
                                                </li>
                                                <li class="col-sm-6 col-lg-4" data-responsive="../../assets/img/media/9.jpg" data-src="../../assets/img/media/9.jpg" data-sub-html="<h4>Gallery Image 9</h4>">
                                                    <a href="" class="wd-100p"><img class="img-responsive mb-4 mb-lg-0" src="../../assets/img/media/9.jpg" alt="Thumb-1"> </a>
                                                </li>
                                            </ul>
                                            <!-- /Gallery -->
                                        </div>
                                                ...
                                                <div class="card custom-card border">
                                                    <div class="card-body text-center">
                                                        <div class="user-lock text-center">
                                                            ...
                                                            </div> <img alt="avatar" class="rounded-circle" src="../../assets/img/users/2.jpg"> </div>
                                                    ...
                                                    <div class="card-body text-center">
                                                        <div class="user-lock text-center">
                                                            <div class="dropdown text-right">
                                                                <a href="#" class="option-dots" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"> <i class="fe fe-more-vertical"></i> </a>
                                                                <div class="dropdown-menu dropdown-menu-right shadow"> <a class="dropdown-item" href="#"><i class="fe fe-message-square mr-2"></i> Message</a> <a class="dropdown-item" href="#"><i class="fe fe-edit-2 mr-2"></i> Edit</a> <a class="dropdown-item" href="#"><i class="fe fe-eye mr-2"></i> View</a> <a class="dropdown-item" href="#"><i class="fe fe-trash-2 mr-2"></i> Delete</a> </div>
                                                            </div> <img alt="avatar" class="rounded-circle" src="../../assets/img/users/3.jpg"> </div>
                                                    ...
                                                    <div class="card-body text-center">
                                                        <div class="user-lock text-center">
                                                            <div class="dropdown text-right">
                                                                <a href="#" class="option-dots" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"> <i class="fe fe-more-vertical"></i> </a>
                                                                <div class="dropdown-menu dropdown-menu-right shadow"> <a class="dropdown-item" href="#"><i class="fe fe-message-square mr-2"></i> Message</a> <a class="dropdown-item" href="#"><i class="fe fe-edit-2 mr-2"></i> Edit</a> <a class="dropdown-item" href="#"><i class="fe fe-eye mr-2"></i> View</a> <a class="dropdown-item" href="#"><i class="fe fe-trash-2 mr-2"></i> Delete</a> </div>
                                                            </div> <img alt="avatar" class="rounded-circle" src="../../assets/img/users/4.jpg"> </div>
                                                    ...
                                                    <div class="card-body text-center">
                                                        <div class="user-lock text-center">
                                                            <div class="dropdown text-right">
                                                                <a href="#" class="option-dots" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"> <i class="fe fe-more-vertical"></i> </a>
                                                                <div class="dropdown-menu dropdown-menu-right shadow"> <a class="dropdown-item" href="#"><i class="fe fe-message-square mr-2"></i> Message</a> <a class="dropdown-item" href="#"><i class="fe fe-edit-2 mr-2"></i> Edit</a> <a class="dropdown-item" href="#"><i class="fe fe-eye mr-2"></i> View</a> <a class="dropdown-item" href="#"><i class="fe fe-trash-2 mr-2"></i> Delete</a> </div>
                                                            </div> <img alt="avatar" class="rounded-circle" src="../../assets/img/users/8.jpg"> </div>
