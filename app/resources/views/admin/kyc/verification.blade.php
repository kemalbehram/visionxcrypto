...
@section('body')
  <div class="page-content"><div class="container"><div class="content-area card"><div class="card-innr"><div class="card-head"><h4 class="card-title">KYC List</h4></div><table class="data-table dt-init kyc-list"><thead><tr class="data-item data-head"><th class="data-col dt-user">User</th><th class="data-col dt-user">Doc Type</th><th class="data-col dt-doc-front">Documents</th><th class="data-col dt-doc-back">&nbsp;</th><th class="data-col dt-status">Status</th><th class="data-col"></th></tr></thead><tbody>

@foreach($kyc as $k=>$data)
  <tr class="data-item"><td class="data-col dt-user"><span class="lead user-name">{{$data->user->username ?? ""}}</span><span class="sub user-id">{{$data->user->email  ?? ""}}</span></td><td class="data-col dt-user"><span class="sub sub-s2 sub-dtype">{{$data->type}}</span></td>
...
</td><td class="data-col text-right"><div class="relative d-inline-block"><a href="{{route('kycview',$data->id)}}" class="btn btn-light-alt btn-xs btn-icon"><em class="ti ti-more-alt"></em></a> </div></td></tr><!-- .data-item -->
@endforeach
