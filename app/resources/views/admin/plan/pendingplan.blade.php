...
@section('body') 
    <div class="page-content"><div class="container"><div class="card content-area"><div class="card-innr"><div class="card-head "><h4 class="card-title">Pending Investment Plan</h4></div>  <div class="table-responsive table-responsive-xl table-responsive-lg table-responsive-md table-responsive-sm">
                        <table class="table table-striped">
                            ...
                            @foreach($plan as $data)
                                <tr>
                                    ...
                                    <td data-label="@lang('Status')" style="padding-top:20px">  @if($data->status == '2')  <span class="badge badge-danger"><i class="fas fa-spinner fa-spin"></i> @lang('Pending')</span>  @else <span class="badge badge-primary">@lang('Active')</span> @endif </td>
                                    <td data-label="@lang('Next Payment')" scope="row" style="font-weight:bold;"><ul class="dropdown-list"><li><a href="{{route('investview',$data->id)}}"><em class="ti ti-eye"></em> View Details</a></li>  </ul> </td>
                                </tr>
