...
@section('body') 
  ...
  <div class="page-header"><div class="container"><div class="row justify-content-center"><div class="col-lg-8 col-xl-7 text-center"><h2 class="page-title">Create New Plan</h2></div></div></div><!-- .container --></div><div class="page-content"><div class="container"><div class="row"> <div class="col-lg-12"><div class="content-area card"><div class="card-innr card-innr-fix2"><div class="card-head"><h6 class="card-title">Create Plan</h6></div><div class="gaps-1x"></div><!-- .gaps -->
...
function myFunction2() {
 ...
 if(type ==  1)
 {
 document.getElementById("type").innerHTML = "<div class='form-group return  '><div class='form-group'><strong>Fixed Amount</strong><input type='number' class='form-control'   name='amount''></div></div> ";}
 if(type ==  0)
 {
 document.getElementById("type").innerHTML = "  <div class='form-group   col-12'> <strong>Minimum Amount</strong> <div class='input-group'> <input type='number' class='form-control'  name='minimum'> </div>  </div> <div class='form-group   col-12' ><strong>Maximum Amount</strong><div class='input-group'>  <input type='number' class='form-control'   name='maximum'> </div>  </div>";}
                                        ...
                                        <div class="input-group-append" style="height: 45px">
                                            <div class="input-group-text">
                                                <select name="interest_status" class="form-control" style="height: 35px !important;">
                                                    <option value="%">%</option>
                                                    <option value="{{$basic->currency_sym}}">{{$basic->currency_sym}}</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
...
function myFunction() {
 ...
 if(expire ==  1)
 {
 document.getElementById("expire").innerHTML = "<div class='form-group return  '><div class='form-group'><strong>Return Times</strong><input type='number' class='form-control'   name='repeat_time'></div></div> ";}
 if(expire ==  0)
 {
 document.getElementById("expire").innerHTML = " ";}
                                ...
                                <div class="form-group col-md-3" >
                                    ...
                                    <input data-toggle="toggle" hidden data-onstyle="success" 
