...
<div class="col-md-12"><div class="input-item input-with-label"><label class="input-item-label text-exlight">Flutterwave Secret Key</label><input value="{{$general->flutterwave_seckey}}"
                                           name="flutterwave_seckey" class="input-bordered" type="text"><span class="input-note">This is needed to facilitate Virtual Card</span></div></div>
...
<div class="col-md-6"><div class="input-item input-with-label"><label class="input-item-label text-exlight">Referral Bonus</label><div class="relative"><span class="input-icon input-icon-right"><em class="ti ti-mobile"></em></span> <input type="text" class="input-bordered"  value="{{$general->ref}}"
                                           onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')"
                                           name="ref"></div><span class="input-note">Input system referral bonus in %. </span></div></div>
