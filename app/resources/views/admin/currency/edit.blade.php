...
<input hidden name="id" value="{{$currency->id}}">
                                               ...
                                               <!--<div class="col-xl-6 col-sm-6"><div class="input-item input-with-label"><label class="input-item-label ucap text-exlight">Currency Price</label><input type="text" name="price" value="{{$currency->price}}"
