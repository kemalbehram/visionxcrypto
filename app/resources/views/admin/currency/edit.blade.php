...
<input hidden name="id" value="{{$currency->id}}">
                                               ...
                                               <input type="text"  hidden  name="price" value="0"
                                                  class="input-bordered"
                                                   ...
                                                   <input hidden type="text" name="payment_id" value="0"
                                               name="payment_id"  hidden  class="input-bordered"
                                               placeholder="Payment Id">
                                               <input type="text" name="payment_id"  hidden  value="0"
                                               name="payment_id" class="input-bordered"
                                               placeholder="Payment Id">
                                               
                                               <!--<div class="col-xl-6 col-sm-6"><div class="input-item input-with-label"><label class="input-item-label ucap text-exlight">Currency Price</label></div></div><div class="col-xl-6 col-sm-6"><div class="input-item input-with-label"><label class="input-item-label ucap text-exlight">Wallet Address</label> <input type="text" name="payment_id" value="{{$currency->payment_id}}"
                                               name="payment_id" class="input-bordered"
                                               placeholder="Payment Id"></div></div></div> --> <div class="col-md-6"><div class="input-item input-with-label"><label class="input-item-label ucap text-exlight">Sell Rate</label> <input type="text" name="sell" value="{{$currency->sell}}" class="input-bordered"
                                                   placeholder="0.00"
