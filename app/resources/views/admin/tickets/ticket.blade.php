...
<div class="page-content"><div class="container"><div class="content-area card"><div class="card-innr"><div class="card-head"><h4 class="card-title">User's Message</h4></div><table class="data-table dt-init kyc-list"><thead><tr class="data-item data-head"><th class="data-col dt-user">Sender</th><th class="data-col dt-user">Subject</th> 

<th class="data-col dt-user">Ticket ID</th> 


<th class="data-col dt-status">Status</th><th class="data-col"></th></tr></thead><tbody>

 @foreach($inbox as $k=>$data)
<tr class="data-item"><td class="data-col dt-user"><span class="lead user-name">{{$data->user->username}}</span><span class="sub user-id">{!! date(' d/M/Y', strtotime($data->created_at)) !!}</span></td><td class="data-col dt-user"><span class="sub sub-s2 sub-dtype">{{$data->title}}</span></td>

<td class="data-col dt-user"><span class="sub sub-s2 sub-dtype">{{$data->code}}</span></td>
