...
<div class="page-content"><div class="container"><div class="content-area card"><div class="card-innr"><div class="card-head"><h4 class="card-title">{{$page_title}}</h4></div>
   ...
   <table class="data-table dt-filter-init admin-tnx"><thead><tr class="data-item data-head"><th class="data-col dt-tnxno">Customer</th><th class="data-col dt-token">Decoder</th><th class="data-col dt-token">Number</th> <th class="data-col dt-account">Amount</th><th class="data-col dt-type"><div class="dt-type-text">Status</div></th> </tr></thead><tbody>
