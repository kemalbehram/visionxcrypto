...
<!-- Banner @s --><div class="header-banner bg-theme-grad-s2"><body class="nk-body body-wider theme-dark"><div class="nk-wrap"><main class="nk-pages nk-pages-centered bg-theme"><div class="ath-container"><div class="ath-header text-center"><a href="{{url('/')}}" class="ath-logo"><img src="{{asset('assets/images/logo/logo.png')}}" width="100" width="150" srcset="{{asset('assets/images/logo/logo.png')}}" alt="logo"></a></div><div class="ath-body"><h5 class="ath-heading title">Sign in <small class="tc-default">Administrative Login</small></h5>
...
</form> </div></main></div><div class="preloader"><span class="spinner spinner-round"></span></div><!-- JavaScript --><script src="{{asset('front-assets/js/jquery.bundle.js?ver=192')}}"></script><script src="{{asset('front-assets/js/scripts.js?ver=192')}}"></script><script src="{{asset('front-assets/js/charts.js')}}"></script>
