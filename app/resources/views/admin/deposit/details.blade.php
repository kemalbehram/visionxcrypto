...
</div><div class="fake-class"><span class="data-details-title">Username</span><span class="data-details-info">  <strong>{{$data->user->username}}</strong> ({{$data->user->email}})</span></div></div><div class="gaps-3x"></div><h6 class="card-sub-title">Transaction Info</h6><ul class="data-details-list"><li><div class="data-details-head">Transaction Type</div><div class="data-details-des"><strong>Deposit</strong></div></li><!-- li --><li><div class="data-details-head">Payment Gateway</div><div class="data-details-des"><strong>@if($data->gateway_id == 0) Bank Transfer @else {{$data->gateway->name }} @endif <small>- Payment Method</small></strong></div></li><!-- li --><li><div class="data-details-head">Amount</div><div class="data-details-des"><strong>{!! number_format($data->amount, $basic->decimal)  !!} {{$basic->currency}}</strong></div></li><!-- li --><li><div class="data-details-head">Deposit Charge</div><div class="data-details-des"><span>{!! number_format($data->charge, $basic->decimal)  !!}{{$basic->currency}}</span> <span></span></div></li><!-- li --><li><div class="data-details-head">Total Amount</div><div class="data-details-des"><span>{!! number_format($data->amount, $basic->decimal)  !!}{{$basic->currency}}</span> <span></span></div></li><!-- li --><li><div class="data-details-head">TRX ID</div><div class="data-details-des">{{$data->trx}}</div></li>
...
</li><!-- li --><li><div class="data-details-head">Hash Number</div><div class="data-details-des">{{$data->code}}</div></li></li><!-- li --><li><div class="data-details-head">Payment Screenshot</div><div class="data-details-des">
