            ...
            <div class="container" style="background-color: #010137">
                ...
                <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #010137">
                    ...
                    <button class="navbar-toggler menu ripplemenu" type="button" data-toggle="collapse"
                        ...
                        <svg viewBox="0 0 64 48" style="stroke: white">
                            ...
                            @if(Auth::user())
                                <a href="{{ route('logout') }}"
                                   onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                    <button type="button" class="btn btn-default c-white" data-toggle="modal"
                                            data-target="#mdllLogin">
                                        Logout
                                    </button>
                                </a>
                                ...
                                <a href="{{route('home')}}"
                                   class="btn scale btn_sm_primary bg-orange-red c-white effect-letter rounded-8">
                                    My Account
                                </a>
                            @else
                                <a type="button" class="btn btn-default c-white" data-toggle="modal"
                                   data-target="#mdllLogin">
                                    Sign in
                                </a>
    ...
    <!-- Start footer -->
                ...
                <div class="row">
                    ...
                    <div class="col-6 col-md-6 col-lg-2">
                        <div class="item_links">
                            <h4>Social</h4>
                            <a class="nav-link"
                               href="https://www.facebook.com/Vision-X-Crypto-Services-Ltd-105417581108721/">Facebook</a>
        ...
        <section class="loading_overlay">
            <div class="loader_logo">
                <img class="logo" src="{{asset('front/img/loading.gif')}}" alt="logo"
        ...
        <!-- Login Modal  -->
        <div class="modal mdllaccount fade" id="mdllLogin" tabindex="-1" role="dialog"
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                                ...
                                                <div class="form-group mb-1 --password" id="show_hide_password">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="password" name="password" class="form-control"
                                                               data-toggle="password" placeholder="+6 Characters"
                                                               required=""/>
                                            ...
                                            <div class="col-12 mt-4">
                                                <button type="submit"
                                                        class="btn rounded-8 btn_xl_primary btn_login effect-letter">
                                                    Sign in
                                                </button>
                                                <a href="{{route('register')}}"
                                                   class="btn mt-3 font-s-15 c-dark text-center w-100">Create new
                                                    account</a>
                                            </div>
                                        </div>
                                    </div>
...
s1.async=true;
s1.src='https://embed.tawk.to/60375c03385de4075719d8c4/1evc3usun';
s1.charset='UTF-8';
